...
namespace collector_forum.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserRoles(List<UserRolesViewModel> model, string userId)
        {
            ...
            var role = await userManager.GetRolesAsync(user); // fix?
            var result = await userManager.RemoveFromRolesAsync(user, role);

            if (!result.Succeeded)   // something happened here?
            {
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMeessage = $"User with ID = {id} cannot be found";
                return View("NotFound");
            }
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMeessage = $"User with ID = {model.Id} cannot be found";
                return View("NotFound");
            }
            else
            {
